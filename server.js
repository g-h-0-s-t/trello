...
app.post('/api/notifications/boards', (req, res) => { req.body.action.type === 'createBoard' ? trello.createHook(AUTH, URL + '/api/notifications/cards', req.body.action.data.board.id, trello.writeUserIds) : res.json({'value': null}) })
